...
public class CameraPreviewController : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IScrollHandler, IDragHandler
{
    ...
    [SerializeField] private float zoomProgressionSpeed;
    [SerializeField] private float rotateProgressionSpeed;
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        {
            shopSystem.CurrentSelectedItemGameobject.transform.Rotate(new Vector3(0, -eventData.delta.x * rotateProgressionSpeed, 0));
        }
    }
    ...
    public void OnScroll(PointerEventData eventData)
    {
        ...
        if (eventData.IsScrolling())
        {
            if(eventData.scrollDelta.y > 0)
            {
                ...
                {
                    itemPreviewContainer.localPosition += (transform.forward * zoomProgressionSpeed);
